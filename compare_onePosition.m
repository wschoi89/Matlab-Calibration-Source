...
%                 angle_offset = angle_offset*pi/180;
                ...
                DH_offset_simulationResult(1,1)=simulationResult(5);
                DH_offset_simulationResult(1,2)=simulationResult(6);
                DH_offset_simulationResult(1,3)=simulationResult(7);
                DH_offset_simulationResult(1,4)=simulationResult(8);
                DH_offset_simulationResult(2,1)=simulationResult(9);
                DH_offset_simulationResult(2,3)=simulationResult(10);
                DH_offset_simulationResult(2,4)=simulationResult(11);
                DH_offset_simulationResult(3,1)=simulationResult(12);
                DH_offset_simulationResult(3,3)=simulationResult(13);
                DH_offset_simulationResult(3,4)=simulationResult(14);
                DH_offset_simulationResult(5,1)=simulationResult(15);
                DH_offset_simulationResult(5,3)=simulationResult(16);
                DH_offset_simulationResult(5,4)=simulationResult(17);
                DH_offset_simulationResult(6,1)=simulationResult(18);
                DH_offset_simulationResult(6,3)=simulationResult(19);
                DH_offset_simulationResult(6,4)=simulationResult(20);
