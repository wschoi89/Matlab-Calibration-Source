...
M=size(data4);
% 
% data3=[2.646 51.058 36.652 73.108 32.144 17.052 61.838 58.212 28.518 7.742 77.224 19.11;
%     -14.21	12.152	55.076	-63.406	15.288	58.702	13.132	71.54	47.04	7.938	76.342	21.07];
...
for iter=1:M(1,1)
    ...
    p0=plot3(Origin_TH(1, 4), Origin_TH(2, 4), Origin_TH(3, 4),'r.-');
    p1=plot3(R1_TH(1,4), R1_TH(2,4), R1_TH(3,4),'r.-');
