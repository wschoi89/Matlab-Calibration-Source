...
%                 angle_offset = angle_offset*pi/180;
                ...
                DH_offset_simulationResult(1,1)=simulationResult(1); DH_offset_simulationResult(1,3)=simulationResult(2); 
                DH_offset_simulationResult(2,1)=simulationResult(3); DH_offset_simulationResult(2,3)=simulationResult(4); 
                DH_offset_simulationResult(3,1)=simulationResult(5); DH_offset_simulationResult(3,3)=simulationResult(6); 

                DH_offset_simulationResult(5,1)=simulationResult(7); DH_offset_simulationResult(5,3)=simulationResult(8); 
                DH_offset_simulationResult(6,1)=simulationResult(9); DH_offset_simulationResult(6,3)=simulationResult(10); 
...
%                 angle_offset = [concat_DHoffset(1), concat_DHoffset(2), concat_DHoffset(3), concat_DHoffset(4)];
                ...
                DHparameter_offset(1,1)=concat_DHoffset(1); DHparameter_offset(1,3)=concat_DHoffset(2); 
                DHparameter_offset(2,1)=concat_DHoffset(3); DHparameter_offset(2,3)=concat_DHoffset(4); 
                DHparameter_offset(3,1)=concat_DHoffset(5); DHparameter_offset(3,3)=concat_DHoffset(6); 

                DHparameter_offset(5,1)=concat_DHoffset(7); DHparameter_offset(5,3)=concat_DHoffset(8); 
                DHparameter_offset(6,1)=concat_DHoffset(9); DHparameter_offset(6,3)=concat_DHoffset(10); 
