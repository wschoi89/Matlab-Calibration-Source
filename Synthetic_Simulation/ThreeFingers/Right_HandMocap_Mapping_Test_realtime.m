...
%     fprintf('Index angle: %3.3f, %3.3f, %3.3f, %3.3f\n', TH1*180/pi, TH2*180/pi, TH3*180/pi, TH4*180/pi);
    fprintf('Index angle: %3.3f, %3.3f, %3.3f, %3.3f\n', jointAngles(5)*180/pi, jointAngles(6)*180/pi, jointAngles(7)*180/pi, jointAngles(8)*180/pi);
%     fprintf('middle angle: %3.3f, %3.3f, %3.3f, %3.3f\n', jointAngles(9)*180/pi, jointAngles(10)*180/pi, jointAngles(11)*180/pi, jointAngles(12)*180/pi);
