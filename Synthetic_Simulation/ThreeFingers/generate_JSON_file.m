...
load('Optimized_parameter/device6/device6_optimized_parameter_thumb.mat');
parameters(1,:) = list_optParam;
load('Optimized_parameter/device6/device6_optimized_parameter_index.mat');
parameters(2,:) = list_optParam;
load('Optimized_parameter/device6/device6_optimized_parameter_middle.mat');
