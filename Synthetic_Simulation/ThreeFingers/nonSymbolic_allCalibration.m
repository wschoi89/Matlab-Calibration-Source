...
options = optimoptions(@lsqnonlin,'Algorithm', 'levenberg-marquardt','Display', 'iter', 'MaxFunctionEvaluations', 10000, 'MaxIterations', 10000, 'initDamping', 10,'StepTolerance', 1e-10);
