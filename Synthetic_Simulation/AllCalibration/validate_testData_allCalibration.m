...
for iter=1:num_iteration
    ...
    for row=1:num_testData
        ...
        DH_offset_simulationResult(1,1)=simulationResult(5); DH_offset_simulationResult(1,2)=simulationResult(15);DH_offset_simulationResult(1,3)=simulationResult(6);DH_offset_simulationResult(1,4)=simulationResult(16); 
        DH_offset_simulationResult(2,1)=simulationResult(7);                                                      DH_offset_simulationResult(2,3)=simulationResult(8); DH_offset_simulationResult(2,4)=simulationResult(17); 
        DH_offset_simulationResult(3,1)=simulationResult(9);                                                      DH_offset_simulationResult(3,3)=simulationResult(10); DH_offset_simulationResult(3,4)=simulationResult(18); 

        DH_offset_simulationResult(5,1)=simulationResult(11);                                                      DH_offset_simulationResult(5,3)=simulationResult(12); DH_offset_simulationResult(5,4)=simulationResult(19); 
        DH_offset_simulationResult(6,1)=simulationResult(13);                                                      DH_offset_simulationResult(6,3)=simulationResult(14); DH_offset_simulationResult(6,4)=simulationResult(20); 
        ...
        concat_DHoffset = list_concat_DHoffset(iter, :);
                ...
                angle_offset(1)=concat_DHoffset(1); 
                angle_offset(2)=concat_DHoffset(2); 
                angle_offset(3)=concat_DHoffset(3); 
                angle_offset(4)=concat_DHoffset(4); 
                
                DHparameter_offset(1,1)=concat_DHoffset(5); DHparameter_offset(1,2)=concat_DHoffset(15);DHparameter_offset(1,3)=concat_DHoffset(6);  DHparameter_offset(1,4)=concat_DHoffset(16);
                DHparameter_offset(2,1)=concat_DHoffset(7);                                             DHparameter_offset(2,3)=concat_DHoffset(8);  DHparameter_offset(2,4)=concat_DHoffset(17);
                DHparameter_offset(3,1)=concat_DHoffset(9);                                             DHparameter_offset(3,3)=concat_DHoffset(10);  DHparameter_offset(3,4)=concat_DHoffset(18);

                DHparameter_offset(5,1)=concat_DHoffset(11);                                             DHparameter_offset(5,3)=concat_DHoffset(12);  DHparameter_offset(5,4)=concat_DHoffset(19);
                DHparameter_offset(6,1)=concat_DHoffset(13);                                             DHparameter_offset(6,3)=concat_DHoffset(14); DHparameter_offset(6,4)=concat_DHoffset(20);
