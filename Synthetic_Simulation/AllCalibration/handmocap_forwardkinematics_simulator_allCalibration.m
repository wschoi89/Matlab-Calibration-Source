...
list_concat_DHoffset = zeros(num_iteration, num_sensor_offset+num_DHparam_length+num_DHparam_angle);
...
nonSymbolic_allCalibration
validate_testData_allCalibration
