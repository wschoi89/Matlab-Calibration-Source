...
% DH_json = jsondecode(fileread('Optimized_parameter/device2/mech-R2.json'));
DH_json = jsondecode(fileread('mech-R4.json'));
...
distance = zeros(1,15);
for i=1:15
    diff_x=pos_calibZig{1,2}(i,1) - Joint6(1);
    diff_y=pos_calibZig{1,2}(i,2) - Joint6(2);
    diff_z=pos_calibZig{1,2}(i,3) - Joint6(3);
    distance(1,i) = sqrt(diff_x^2+diff_y^2+diff_z^2);
end


% fprintf('Index: %3.3f, %3.3f, %3.3f\n', Joint6(1), Joint6(2), Joint6(3));
for i=1:15
    fprintf('%3.3f  ', distance(1,i));
    if i==15
       fprintf('\n'); 
    end
end
