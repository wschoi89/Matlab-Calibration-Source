...
DH_json = jsondecode(fileread('mech-R11.json'));

% num_zigPos_training = [36, 36, 36]; % thumb, index, middle 
num_zigPos_training = [30, 30, 30]; % thumb, index, middle 
...
%     fileName_magneticData=strcat('DAQ/',device_name,'/training/',device_name,'_DAQ_T',num2str(n_pos),'_I',num2str(n_pos),'_M',num2str(n_pos),'_training.csv');
  fileName_magneticData=strcat('DAQ/',device_name,'/test/index/',device_name,'_DAQ_I',num2str(n_pos),'_test.csv');  
% fileName_magneticData=strcat('DAQ/',device_name,'/test/middle/',device_name,'_DAQ_T',num2str(n_pos),'_I',num2str(n_pos),'_M',num2str(n_pos),'_test.csv');
%     fileName_magneticData=strcat('DAQ/',device_name,'/',device_name,'_DAQ_T',num2str(n_pos),'_I',num2str(n_pos),'_M',num2str(n_pos),'.csv');
%     fileName_magneticData=strcat('DAQ/',device_name,'/','index/',device_name,'_DAQ_T',num2str(n_pos),'_I',num2str(n_pos),'_M',num2str(n_pos),'_training.csv');
