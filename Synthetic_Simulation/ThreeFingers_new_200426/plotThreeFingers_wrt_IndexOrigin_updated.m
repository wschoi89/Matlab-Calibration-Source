...
num_zigPos = [32, 30, 30]; % thumb, index, middle 
...
%     fileName_magneticData=strcat('DAQ/',device_name,'/test/index/',device_name,'_DAQ_I',num2str(n_pos),'_test.csv');
        fileName_magneticData=strcat('DAQ/',device_name,'/test/thumb/',device_name,'_DAQ_T',num2str(n_pos),'_I',num2str(n_pos),'_M',num2str(n_pos),'_test.csv');
